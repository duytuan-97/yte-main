...
<head>
    ...
    <link href="{{asset('admin/assets/vendor/fullcalendar/css/main.min.css')}}" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="https://static.lahera.vn/" class="brand-logo">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							<div class="input-group search-area right d-lg-inline-flex d-none">
								<input type="text" class="form-control" placeholder="Tìm trong trang">
								<div class="input-group-append">
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{asset('admin/assets/images/Untitled-1.jpg')}}" width="20px" alt="">
...
<!--**********************************
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<div class="copyright">
					<p><strong>Lahera Admin Dashboard</strong> © 2023 All Rights Reserved</p>
					<p class="fs-12">Made with <span class="heart"></span> by IT Venus</p>
				</div>
			</div>
        </div>
        <!--**********************************
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Nội dung 1</a>
                            <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Nội dung 2</a>
                            <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Nội dung 3</a>
                        </div>
                    </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="../index.htm" target="_blank">IT Venus</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <script src="{{asset('admin/assets/vendor/fullcalendar/js/main.min.js')}}"></script>
	<script src="{{asset('admin/assets/js/plugins-init/fullcalendar-init.js')}}"></script>
